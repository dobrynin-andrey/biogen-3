...
$(document).ready(function () {
     ...
     *****************************************************/
       ...
       //var k1 = 1;
        ...
        var R6 = -U4*C4 - U36*C3 + L5*C5;  // минерального форсфора
        console.log("------------------------------------");
        console.log("R6: "+R6);
        ...
        /* Скорость трансформации */
        var R7 = L4*C7 - U5*C5 + L2*C2 + L3*C8 + k8*C8;  // минерального форсфора
        console.log("------------------------------------");
        console.log("R7: "+R7);
        ...
        /* Скорость трансформации */
        var R8 = C1*(S1-U18) + C2*(S2-U28) + S3*C3 + S4*C4 + S5*C5 - k8*C8;  // минерального форсфора
        console.log("------------------------------------");
        console.log("R8: "+R8);
     ...
     /******************************************************
      *****{ Величина нагрузки (Ji*Omg + Ei*L) }************
      ******************************************************/

        /**
         * Где:
         * L и Omg(Омега) - Длина, м; и площадь зеркала, м2
         * Ji - поток вещества через межфазные поверхности, г/(м2*сут)
         * Ei - боковая нагрузка, связанная с поступлением с берегов, кроме учитываемых притоков, г/(м*сут)
         */

        /* Для потока оседающего детрита: */

        var Ks = 2.0;
        var Jout8 = Ks*C8;

        /* Поток взвеси со дня в воду: */

        var b8 = [6.4 * Math.pow(10,-3), 0.1];  // Тут пока вопрос!!!!

        var V = 1; // - скорость ветра
        var H = 1; // - средняя глубина водоема в расчетный момент времени
        var Jin8 = b8 * (V/H);

        /* Поток P на границе вода - дно */

        var J8 = -Jout8 + Jin8;

        console.log("------------------------------------");
        console.log("Поток P на границе вода - дно: "+J8);
    });
